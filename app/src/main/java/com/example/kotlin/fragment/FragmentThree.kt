 ...
 * Describe:
 */
class FragmentThree : BaseFragment<FragmentOneLayoutBinding>() {

    override fun init(savedInstanceState: Bundle?) {
        super.init(savedInstanceState)
        viewBind.fragmentBackLayout.setBackgroundColor(Color.parseColor("#ff0000"))
        viewBind.fragmentText.text = "Fragment Three"
