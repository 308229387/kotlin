...
//    val textSource = Html.fromHtml("修改TextView中部分文字的<font color='#ff0000'><big>大</big><small>小</small></font>和<font color='#00ff00'>颜色</font>，展示多彩效果！"+"<strong><big><font color=#ff0000>新橙慧安-合成研判平台</font></big></strong>"+"<h3 </h3>"+"<h3 style=\"color:#007AAA\">新橙慧安-合成研判平台</h3>")
    val textSource = Html.fromHtml("<html>\n" +
            ...
            "<h3> <strong><big><font color=#ff0000>新橙慧安-合成研判平台</font></big></strong></h3>\n" +//里面的标签可以删除
