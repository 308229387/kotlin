...
import com.example.kotlin.databinding.ActivityPersionWarningBinding;
import com.example.kotlin.utils.ToastUtil;

import java.util.ArrayList;
import java.util.List;

public class PersonWarningActivity extends BaseActivity<ActivityPersionWarningBinding> implements OnItemClickListener,
        OnLoadMoreListener {
    ...
    @NonNull
    @Override
    public ActivityPersionWarningBinding createViewBinding() {
        return ActivityPersionWarningBinding.inflate(getLayoutInflater());
    }
}
